...
var createDriveLink = function () {
  var _ref15 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee12(options, parentId, folderName, driveLink) {
    var route, method, params;
      ...
      while (1) {
        switch (_context12.prev = _context12.next) {
          case 0:
            ...
            return _context12.abrupt('return', (0, _superagent2.default)(method, route).send(params));
  ...
  return function createDriveLink(_x23, _x24, _x25, _x26) {
    return _ref15.apply(this, arguments);
  };
}();

var renameResource = function () {
  var _ref16 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee13(options, id, newName) {
    var route, method;
      ...
      while (1) {
        switch (_context13.prev = _context13.next) {
          case 0:
            route = options.apiRoot + '/files/' + id;
            method = 'PATCH';
            return _context13.abrupt('return', (0, _superagent2.default)(method, route).type('application/json').send({ name: newName }));
  ...
  return function renameResource(_x27, _x28, _x29) {
    return _ref16.apply(this, arguments);
  };
}();

var removeResource = function () {
  var _ref17 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee14(options, resource) {
    var route, method;
      ...
      while (1) {
        switch (_context14.prev = _context14.next) {
          case 0:
            ...
            method = 'DELETE';
            return _context14.abrupt('return', (0, _superagent2.default)(method, route));
  ...
  return function removeResource(_x30, _x31) {
    return _ref17.apply(this, arguments);
  };
}();

var removeResources = function () {
  var _ref18 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee15(options, selectedResources) {
    return _regenerator2.default.wrap(function _callee15$(_context15) {
      while (1) {
        switch (_context15.prev = _context15.next) {
          case 0:
            return _context15.abrupt('return', Promise.all(selectedResources.map(function (resource) {
  ...
  return function removeResources(_x32, _x33) {
...
exports.default = {
  ...
  createDriveLink: createDriveLink
};